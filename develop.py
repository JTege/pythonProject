...
if unit.upper() == 'K': # case sensitive language
    ...
    converted = weight * 2.20.__round__(4)
...
waiting_positions = [1, 2, 3, 4, 5]
waiting_positions.insert(0, -1) # insert any type of object - str, bool, int, etc.
print(waiting_positions)
...
waiting_positions = [1, 2, 3, 4, 5]
print(3 in waiting_positions) # return bool value
